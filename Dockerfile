...
ADD python-opt-2.7.7-2.spec /root/rpmbuild/SPECS/python-opt-2.7.7-2.spec
ADD python-opt-setuptools.spec /root/rpmbuild/SPECS/python-opt-setuptools.spec
RUN chown root:root /root/rpmbuild/SPECS/python-opt-2.7.7-2.spec /root/rpmbuild/SPECS/python-opt-setuptools.spec
RUN /root/build27.sh
RUN rpm -ivh /root/rpmbuild/RPMS/x86_64/python27-opt-libs-2.7.7-2br.x86_64.rpm
RUN rpm -ivh /root/rpmbuild/RPMS/x86_64/python27-opt-2.7.7-2br.x86_64.rpm
RUN rpm -ivh /root/rpmbuild/RPMS/x86_64/tkinter27-2.7.7-2br.x86_64.rpm
RUN rpm -ivh /root/rpmbuild/RPMS/x86_64/python27-opt-devel-2.7.7-2br.x86_64.rpm
